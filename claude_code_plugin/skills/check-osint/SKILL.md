---
name: check-osint
description: Gather OSINT context on a customer or counterparty — adverse media, regulator actions, corporate registry records — via the osint MCP server. Subject to an outbound allowlist on fetch_page.
---
