...
description: Screen a customer or counterparty against OFAC-style watchlists (SDN, EU, UN, UK HMT) via the sanctions MCP server. Returns hit details suitable for the report.
---
